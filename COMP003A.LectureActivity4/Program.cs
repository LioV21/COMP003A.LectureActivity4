...
* Course: COMP-003A
* PurposeL Code for Lecture Activity 4 
...
namespace COMP003A.LectureActivity4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            * 1. ubt counter = 0; => loop variablle initialization 
            ...
            */
            for (int counter = 0; counter < limit; counter++)
            {
                ...
                Console.WriteLine($"\tCurrent item: {counter}");
            }
             ...
             * Boolean expresssion evaluates to true. Because that expression is evalutaed after
             * each execution of the loop, a do loop execcutes one or more times. The do 
             * staatement differes from a while loop, which executes zero or more times. 
            */
            ...
            do
            {
                ...
                counter2++; // increment counter2 by 2
            ...
            * Boolean expression evaluatews to true. Because that expression is evaluated before 
            ...
            */
            ...
            while (counter3 < 20)
            {
                Console.WriteLine($"t\tCurrent counter3: {counter3}");
                counter3 += 2; // add 2 to the value of counter3
            }
            Console.WriteLine("\n"); // new line 
            Console.WriteLine("".PadRight(50, '*'));
            Console.WriteLine("example for loop program that counter from 1-20 abd checks if it is odd or even");
            Console.WriteLine("".PadRight(50, '*'));
